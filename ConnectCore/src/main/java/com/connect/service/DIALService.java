...
public class DIALService extends DeviceService implements Launcher {
    ...
    public void setServiceDescription(ServiceDescription serviceDescription) {
        ...
        if (responseHeaders != null) {
            ...
            if (commandPaths != null && !commandPaths.isEmpty()) {
    ...
    public void launchAppWithInfo(final AppInfo appInfo, Object params, final AppLaunchListener listener) {
        ServiceCommand<ResponseListener<Object>> command = new ServiceCommand<>(getCommandProcessor(), requestURL(appInfo.getName()), params, new ResponseListener<Object>() {
            @Override
    ...
    public void closeApp(final LaunchSession launchSession, final ResponseListener<Object> listener) {
        getAppState(launchSession.getAppName(), new AppStateListener() {
            ...
            public void onSuccess(AppState state) {
                ...
                else uri = requestURL(launchSession.getSessionId());
    ...
    @Override
    public ServiceSubscription<AppStateListener> subscribeAppState(LaunchSession launchSession, Launcher.AppStateListener listener) {
        return null;
    }
    ...
    public void disconnect() {
        ...
        Util.runOnUI(new Runnable() {
            ...
            @Override
            public void run() {
                if (listener != null) listener.onDisconnect(DIALService.this, null);
            }
        });
    }
