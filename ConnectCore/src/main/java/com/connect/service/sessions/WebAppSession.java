...
public class WebAppSession implements MediaControl, MediaPlayer, PlaylistControl {
    ...
    public void play(ResponseListener<Object> listener) {
        ...
        if (service != null) mediaControl = service.getAPI(MediaControl.class);

        if (mediaControl != null) mediaControl.play(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    public void previous(ResponseListener<Object> listener) {
        ...
        if (mediaControl != null) mediaControl.previous(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    public void next(ResponseListener<Object> listener) {
        ...
        if (mediaControl != null) mediaControl.next(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    public void getDuration(DurationListener listener) {
        ...
        if (mediaControl != null) mediaControl.getDuration(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    public void getPosition(PositionListener listener) {
        ...
        if (mediaControl != null) mediaControl.getPosition(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    public void getPlayState(PlayStateListener listener) {
        ...
        if (mediaControl != null) mediaControl.getPlayState(listener);
        else if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
