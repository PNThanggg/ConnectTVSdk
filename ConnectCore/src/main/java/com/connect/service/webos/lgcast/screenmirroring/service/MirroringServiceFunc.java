...
import com.connect.service.webos.lgcast.common.transfer.RTPStreamerData;
import com.connect.service.webos.lgcast.common.utils.AppUtil;
import com.connect.service.webos.lgcast.common.utils.DeviceUtil;
...
public class MirroringServiceFunc {
    ...
    public static MediaProjection getMediaProjection(Context context, Intent intent) {
        ...
        return (intent != null) ? projectionManager.getMediaProjection(
                Activity.RESULT_OK,
                intent.getParcelableExtra(MirroringServiceIF.EXTRA_PROJECTION_DATA
            )
        ) : null;
    }
    ...
    public static boolean isDualScreen(Intent intent) {
        return intent != null && intent.getBooleanExtra(MirroringServiceIF.EXTRA_IS_DUAL_SCREEN, false);
    }
    ...
    private static Point calculateVideoCaptureSize(Context context, boolean isDisplayLandscape) {
        ...
        return (isDisplayLandscape) ? new Point(w, h) : new Point(h, w);
    }
