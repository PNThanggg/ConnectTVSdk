...
public class CameraUtility {
    ...
    public static List<Size> getSupportedPreviewSizes(Context context) {
        ...
        return (info != null) ? Arrays.asList(info.getOutputSizes(ImageFormat.YUV_420_888)) : Collections.emptyList();
    }
    ...
    public static int calculateBrightness(CameraCharacteristics cameraCharacteristics, int value) {
        ...
        if (value < RemoteCameraConfig.Properties.MIN_BRIGHTNESS || value > RemoteCameraConfig.Properties.MAX_BRIGHTNESS)
            return -1;
    ...
    public static RggbChannelVector calculateWhiteBalance(int value) {
        if (value < RemoteCameraConfig.Properties.MIN_WHITE_BALANCE || value > RemoteCameraConfig.Properties.MAX_WHITE_BALANCE)
            return null;
