package com.connect.service.webos.lgcast.screenmirroring.uibc;
...
import com.connect.service.webos.lgcast.screenmirroring.service.MirroringServiceFunc;
...
public class UibcAccessibilityService extends AccessibilityService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (START_SERVICE.equals(action)) startService();
        if (STOP_SERVICE.equals(action)) stopService();
        return START_STICKY;
    }
