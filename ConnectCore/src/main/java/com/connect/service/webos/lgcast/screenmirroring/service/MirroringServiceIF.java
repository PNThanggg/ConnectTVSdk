...
import com.connect.service.webos.lgcast.common.utils.AudioUtil;
...
public class MirroringServiceIF {
    ...
    public static MirroringServiceError toMirroringError(ConnectionManagerError connectionError) {
        ...
        else if (connectionError == ConnectionManagerError.RENDERER_TERMINATED)
            return MirroringServiceError.ERROR_RENDERER_TERMINATED;
