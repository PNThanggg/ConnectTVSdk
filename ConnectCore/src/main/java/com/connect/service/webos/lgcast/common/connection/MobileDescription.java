...
public class MobileDescription {
    ...
    public MobileDescription(Context context) {
        ...
        if (deviceName == null || deviceName.isEmpty()) deviceName = Settings.Secure.getString(context.getContentResolver(), "bluetooth_name");
        if (deviceName == null || deviceName.isEmpty()) deviceName = Build.MODEL;
    }
