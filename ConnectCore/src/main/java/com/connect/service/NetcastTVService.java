...
import com.connect.etc.helper.HttpConnection;
import com.connect.etc.helper.HttpMessage;
...
import com.connect.service.config.NetcastTVServiceConfig;
import com.connect.service.config.ServiceConfig;
import com.connect.service.config.ServiceDescription;
import com.connect.service.netcast.NetcastAppNumberParser;
import com.connect.service.netcast.NetcastApplicationsParser;
import com.connect.service.netcast.NetcastChannelParser;
import com.connect.service.netcast.NetcastHttpServer;
import com.connect.service.netcast.NetcastVirtualKeycodes;
import com.connect.service.netcast.NetcastVolumeParser;
...
public class NetcastTVService extends DeviceService implements Launcher, MediaControl, MediaPlayer, TVControl, VolumeControl, ExternalInputControl, MouseControl, TextInputControl, PowerControl, KeyControl {
    ...
    String TARGET_CHANNEL_LIST = "channel_list";
    ...
    public void connect() {
        ...
        if (DiscoveryManager.getInstance().getPairingLevel() == DiscoveryManager.PairingLevel.ON) {
            if (((NetcastTVServiceConfig) serviceConfig).getPairingKey() != null && !((NetcastTVServiceConfig) serviceConfig).getPairingKey().isEmpty()) {
    ...
    public void disconnect() {
        ...
        Util.runOnUI(new Runnable() {
            ...
            @Override
            public void run() {
                if (listener != null) listener.onDisconnect(NetcastTVService.this, null);
            }
        });
    ...
    public void showPairingKeyOnTV() {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object response) {
                if (listener != null) listener.onPairingRequired(NetcastTVService.this, pairingType, null);
            }
    ...
    static class NetcastTVLaunchSessionR extends LaunchSession {
        String appName;
    ...
    public void getApplication(final String appName, final AppInfoListener listener) {
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onError(ServiceCommandError error) {
                if (listener != null) Util.postError(listener, error);
            }
        };
    ...
    public void launchBrowser(String url, final Launcher.AppLaunchListener listener) {
        if (!(url == null || url.length() == 0)) Log.w(Util.T, "Netcast TV does not support deeplink for Browser");
    ...
    public void closeApp(LaunchSession launchSession, ResponseListener<Object> listener) {
        ...
        if (launchSession.getAppName() != null) params.put("appname", HttpMessage.encode(launchSession.getAppName()));
    ...
    public void getAppState(final LaunchSession launchSession, final AppStateListener listener) {
        String requestURL = String.format(Locale.US, "%s%s", getUDAPRequestURL(UDAP_PATH_APPTOAPP_DATA), String.format(Locale.US, "/%s/status", launchSession.getAppId()));
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object object) {
                ...
                AppState appState;
                if (response.equalsIgnoreCase("NONE")) appState = new AppState(false, false);
                else if (response.equalsIgnoreCase("LOAD")) appState = new AppState(false, true);
                else if (response.equalsIgnoreCase("RUN_NF")) appState = new AppState(true, false);
                else if (response.equalsIgnoreCase("TERM")) appState = new AppState(false, true);
                else appState = new AppState(false, false);
            ...
            public void onSuccess(List<ChannelInfo> channelList) {
                ...
                for (int i = 0; i < channelList.size(); i++) {
                    ...
                    try {
                        ...
                        if (Integer.parseInt(major) == majorNumber && Integer.parseInt(minor) == minorNumber) {
    ...
    public void getCurrentChannel(final ChannelListener listener) {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            public void onSuccess(Object response) {
                ...
                } catch (ParserConfigurationException | JSONException | IOException | SAXException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void getMediaInfo(final MediaInfoListener listener) {
        ...
        if (getDLNAService() != null) {
            ...
            if (listener != null) Util.postError(listener, ServiceCommandError.notSupported());
        }
    }
        ...
        if (getDLNAService() != null) {
            final MediaPlayer.LaunchListener launchListener = new LaunchListener() {
                ...
                public void onSuccess(MediaLaunchObject object) {
                    ...
                    if (listener != null) Util.postSuccess(listener, object);
                }
            };
    ...
    public MediaControl getMediaControl() {
        if (DiscoveryManager.getInstance().getPairingLevel() == DiscoveryManager.PairingLevel.OFF) return this.getDLNAService();
        else return this;
    }
    ...
    public void move(double dx, double dy) {
        mMouseDistance.x += (float) dx;
        mMouseDistance.y += (float) dy;
    ...
    private void moveMouse() {
        ...
        ResponseListener<Object> responseListener = new ResponseListener<Object>() {
            ...
            @Override
            public void onSuccess(Object response) {
                if (mMouseDistance.x > 0 || mMouseDistance.y > 0) mouseService.moveMouse();
                else mMouseIsMoving = false;
            }
    ...
    public void scroll(double dx, double dy) {
        ...
        if (dy > 0) params.put("value", "up");
        else params.put("value", "down");
    ...
    public void powerOn(ResponseListener<Object> listener) {
        if (listener != null) listener.onError(ServiceCommandError.notSupported());
    }
    ...
    private void addSubscription(URLServiceSubscription<?> subscription) {
        ...
        if (httpServer != null) httpServer.setSubscriptions(subscriptions);
    }
